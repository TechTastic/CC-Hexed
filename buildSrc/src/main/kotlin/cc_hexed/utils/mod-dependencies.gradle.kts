...
abstract class CCHexedModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<CCHexedModDependenciesExtension>("cchexedModDependencies")
