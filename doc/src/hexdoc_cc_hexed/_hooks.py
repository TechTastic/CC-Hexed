...
import hexdoc_cc_hexed

from .__gradle_version__ import FULL_VERSION, MOD_ID, MOD_VERSION
from .__version__ import PY_VERSION


class CCHexedPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return CCHexedModPlugin(branch=branch)


class CCHexedModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return MOD_ID
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_cc_hexed, "_templates"
