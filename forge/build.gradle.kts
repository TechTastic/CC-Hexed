...
loom {
    forge {
        ...
        mixinConfig(
            "cc_hexed-common.mixins.json",
            "cc_hexed-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("cc_hexed.apply-datagen-mixin", "true")
                property("cc_hexed.$platform-datagen", "true")
            }
        }
    }
}

cchexedModDependencies {
